...
const allowedWords = [
  ...
  "CRUSH", "CURLY", "CYCLE", "DADDY", "DAILY", "DANCE", "DOKER", "DATED", "DAUNT", "DEALT",
  ...
  "FAITH", "FALSE", "FANCI", "FANCY", "FARCE", "FRAME", "FATAL", "FAULT", "FAVOR", "FEAST",
  "FLING", "FEWER", "FIBER", "FIELD", "FIFTY", "FIGHT", "FILET", "FINAL", "FIRST", "FISKY",
  "FIXED", "FLAME", "FLASH", "FLEET", "Flesh", "FLING", "FLOOD", "FLOOR", "FLOUR", "FLUID",
  "FLUSH", "FOCAL", "FOCUS", "FORGE", "FORTH", "FORTY", "FORUM", "FOUND", "FRAGG", "FRANK",
  ...
  "GRIEF", "GRILL", "GRIND", "GROOM", "GROSS", "GROUP", "GROWL", "GUEST", "GUIDE", "GULLY",
  "HABIT", "HALLS", "HANDY", "HAPPY", "HARMS", "HASTY", "HAVOC", "HAZEL", "HEART", "HEAVY",
  "HENCE", "HIGHX", "HIKER", "HILLS", "HINTS", "HIRED", "HOLLY", "HONEY", "HONOR", "HORSE",
  "HOTEL", "HUMAN", "HUMOR", "HENRY", "HURRY", "IDEAS", "IMAGE", "IMPLY", "COMES", "INDEX",
  "INFER", "INNER", "INPUT", "INTEL", "ISSUE", "ITCHY", "JOINS", "JOIST", "JOKER", "JOLLY",
  "JUMPY", "JUROR", "KARMA", "KEENS", "KEEPS", "KILLS", "KINDS", "KINGS", "KINKY", "KNEEL",
  ...
  "RADIO", "RAILS", "RAISE", "RANDY", "RANGE", "RANKS", "RAPID", "ARELY", "RATES", "RATIO",
  "RAZOR", "REACH", "REACT", "READY", "REALM", "REBEL", "RECAL", "RECON", "REFER", "REIGN",
  ...
  "SCOUT", "SCREW", "SEALS", "SEAMS", "MERCH", "SEATS", "SOUND", "SECRE", "SECTS", "CURES",
  ...
  "SHOTS", "SHOUT", "SHOWN", "SHRUG", "SHUTS", "SICKY", "SIDES", "SIEGE", "WIGHT", "SIGNS",
  "SILEN", "SILKY", "SILVA", "SIMPL", "SINGS", "SINKY", "SIREN", "SIXTH", "SIZED", "SKILL",
  "SKIRT", "SLAVE", "SLEEP", "SLICE", "SLIDE", "SIGHT", "SLING", "SLOPE", "SLOTH", "SMALL",
  "SMART", "SMELL", "SMILE", "SMOKE", "SNAKE", "SNOWY", "SOAPS", "SOBER", "SOLID", "SOLVE",
  "SOMEX", "SONGS", "SONER", "SORRY", "SOUTH", "SPACE", "SPARE", "SPARK", "SPEND", "STAKE",
  ...
  "TREES", "TREND", "TRIAD", "TRIBE", "TRICK", "TRITE", "FREAK", "TRIMY", "TRIED", "FRIED",
  ...
  "VOWEL", "WAGON", "WAIST", "WAKEN", "ANDER", "WATCH", "WATER", "WEARY", "WHEEL", "STEAK",
  "WHIFF", "WHILE", "WHINE", "WHIRL", "WHITE", "WHOLE", "WIDEN", "WINDY", "WINCE", "WOMAN",
  "WORLD", "WORRY", "WORTH", "WOVEN", "WRATH", "WRECK", "WRITE", "WRONG", "YACHT", "YIELD",
  "YOUNG", "ZEBRA", "ZONAL", "ZONED", "ZOOMY", "ZONKS", "ABACK", "ABASH", "ABATE", "ABBEY", 
  "ABBOT", "ABHOR", "ABIDE", "ABOVE", "EBONY", "ABOUT", "SUCKS", "SHAVE", "WHERE", "WHICH",
  ...
  "HINTS", "HONEY", "HONOR", "HORSE", "HOTEL", "HOUSE", "HUMAN", "HUMOR", "PIGRY", "HURRY",
  "IDEAL", "IMAGE", "IMPLY", "ICOME", "INDEX", "INFER", "INNER", "INPUT", "ISSUE", "ITCHY",
  ...
  "MOIST", "MONEY", "MOODY", "MORAL", "MURAL", "BAGEL",
  ...
  "SMOKE", "SNAKE", "SNEAK", "SNOUT", "SOLVE", "SPOIL", "SPORT", "SPURT", "SQUID",
  ...
  "UMBRA", "UNIFY", "UNION", "UNZIP", "UPPER", "URBAN", "USHER", "VALID", "VALUE", "VAPOR",
  "VAULT", "VENUE", "VERGE", "VERSE", "VIEWS", "VILLA", "VINES", "VITAL", "VIVID", "VOICE",
  "VOWEL", "WAGON", "WAIST", "WAKEN", "INTER", "WATCH", "WATER", "WEARY", "WHEEL", "PUSSY",
  "WHIFF", "WHILE", "WHINE", "WHIRL", "WHITE", "WHOLE", "WIDEN", "WINDY", "WINCE", "WOMAN",
  "WORLD", "WORRY", "WORTH", "WOVEN", "WRATH", "WRECK", "WRITE", "WRONG", "YACHT", "YIELD",
  "YOUNG", "ZEBRA", "ZONAL", "ZONED", "ZOOMY", "ZONKS", "EARTH", "BAKED", "BLAST", "CHORD",
  "FROZE", "GRAPE", "HELLO", "JAZZY", "KNEEL", "LEAVE", "MAGIC", "NURSE", "OVALS", "PIANO",
];
...
const solutionWords = [
  ...
  "APPLY", "APRIL", "APTLY", "ARCHY", "ARENA", "ARGUE", "ARISE", "ARMOR", "AROMA", "AROSE",
  "ASIDE", "AUDIO", "AUNIT", "AUNTY", "AVAIL", "AVERT", "AWAIT", "AWAKE", "AWARD", "AWARE",
  "AWFUL", "AXIOM", "AZTEC", "BAKED", "BLAST", "CHORD", "DAISY", "BABEL", "BADGE", "BAKER",
  "BALDY", "BASIC", "BASIN", "BATCH", "EARTH", "FROZE", "GRAPE", "HELLO", "JAZZY", "KNEEL",
  "LEAVE", "MAGIC", "NURSE", "OVALS", "PIANO", "BATHS", "BATON", "BEACH", "BEADY", "BEAMY", 
  "BEANS", "BEARD", "BEAST", "BEAUT", "BEGIN",
  "BEGUN", "BEING", "BELOW", "BIBLE", "BIGOT", "BLAME", "BLAND", "BLANK", "BLEAK", "BLIND",
  "BLOAT", "BLUFF", "BOARD", "BOAST", "BONES", "BOOTH", "BORED", "BOUND", "BOWEL", "BRAIN",
  "BRASS", "BRAVE", "BREAD", "BREAK", "BRIDE", "BRING", "BROAD", "BROKE", "BROWN", "BUILD",
  "BULKY", "BUNCH", "BURST", "CABIN", "CABLE", "CANAL", "CANDY", "CARRY", "CATER", "CAUSA",
  ...
  "GRILL", "GRIND", "GROOM", "GROSS", "GROUP", "GROWL", "GUEST", "GUIDE", "HABIT", "HALLS",
  "HANDY", "HAPPY", "HARMS", "HASTY", "HAVOC", "HEART", "HEAVY", "HENCE", "HIKER", "HILLS",
  "HINTS", "HONEY", "HONOR", "HORSE", "HOTEL", "HOUSE", "HUMAN", "HUMOR", "HURRY", "PUSSY",
  "IDEAL", "IMAGE", "IMPLY", "INDEX", "INFER", "INNER", "INPUT", "ISSUE", "ITCHY", "NOSES",
  "JOINT", "JOIST", "JOKER", "JOLLY", "JUMPY", "JUROR", "KAYAK", "KAZOO", "KNACK", "KNELT",
  "LABEL", "LADLE", "LAKEY", "LATCH", "LATHE", "LAYER", "LEMON", "LIBEL", "LIGHT", "LIMBO",
  "LITER", "LOBBY", "LODGE", "LOOSE", "LORDS", "LOVER", "LOVES", "LUCKY", "LUMPY", "LUNGE",
  "MANOR", "MARCH", "MATCH", "MAVEN", "MECCA", "MERRY", "MICRO", "MIMIC", "MINIM", "MODEL",
  "MOIST", "MONEY", "MOODY", "MORAL", "MURAL", "YOUNG", "ZEBRA", "ZONAL", "ZONED", "ZOOMY",
  "ZONKS", "MYTHS", "NAIVE", "NAVEL", "NEIGH", "NIGHT", "NINJA", "NOBLE", "NOMAD", "NORTH",
  "OASIS", "OCEAN", "OCTAL", "OFTEN", "OLIVE", "OMEGA", "OPERA", "ORBIT", "ORDER", "OUNCE",
  "OUTER", "OZONE", "PALSY", "PANEL", "PARKA", "PARTY", "PEACE", "PEARL", "PECAN", "PERCH",
  "PINEA", "PIXEL", "PLANK", "PLUSH", "POISE", "POLAR", "POOCH", "POPPA", "PORCH", "POUND",
  "POWER", "PRANK", "PRIME", "PROBE", "PROXY", "PUPIL", "PUPPY", "QUEEN", "QUICK", "QUIET",
  ...
  "UMBRA", "UNIFY", "UNION", "UNZIP", "UPPER", "URBAN", "USHER", "VALID", "VALUE", "VAPOR",
  "VAULT", "VENUE", "VERGE", "VERSE", "VIEWS", "VILLA", "VINES", "VITAL", "VIVID", "VOICE",
  "VOWEL", "WAGON", "WAIST", "WAKEN", "WATCH", "WATER", "WEARY", "WHEEL", "YACHT", "YIELD",
  "WHIFF", "WHILE", "WHINE", "WHIRL", "WHITE", "WHOLE", "WIDEN", "WINDY", "WINCE", "WOMAN",
  "WORLD", "WORRY", "WORTH", "WOVEN", "WRATH", "WRECK", "WRITE", "WRONG", 
